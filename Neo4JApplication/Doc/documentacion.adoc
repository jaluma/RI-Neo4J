...
----
"c": +
{"nombre":"Damion","pais":"Alemania","apellido":"Frost"}
...
----
"c": +
{"nombre":"Joan","edad":23,"apellido":"Garrido"} +
{"nombre_artistico":"Carlos Right","nombre":"Carlos"} +
{"nombre_artistico":"Alba Reche","nombre":"Alba"}
